...
class FormInput extends StatelessWidget {
  ...
  const FormInput(
      {this.label, this.password, this.enabledColor, this.focusColor});
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color:
                  enabledColor == null ? Colors.grey.shade400 : enabledColor),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8.0),
          borderSide:
              BorderSide(color: focusColor == null ? primaryColor : focusColor),
        ),
      ),
    );
  }
